//<![CDATA[
		...
		$(FuncInit.idrbb).change(function(){FuncTree.bms=false;FuncTree.bms=false;MapsLib.srchOnAll(this.value);$(FuncInit.idinf).empty();FuncTab.msg= 'Pour Afficher les donners, cliquer ailleurs!!';FuncTree.append(FuncTab.msg,'red');});
		$(FuncInit.idrbb).mouseleave(function(){FuncTab.crTb();MapsLib.displayList();FuncTab.fshBDD();FuncTab.search='';});
		$(FuncInit.idrbb).click(function(){$(FuncInit.idinf).empty();FuncTab.msg= 'Pour Afficher les donners, visoinner les donner en bas de l Ecran!!';FuncTree.append(FuncTab.msg,'blue');});
