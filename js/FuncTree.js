...
var FuncTree = {
	...
	source 		: [   
			{ id:"E", html: "<span style='color: #DAA520;'>EST</span>",  value:"1kdUa3ca31BGjEODS180K8B1zsF9ArFmIZLPiiaRp", items: [
				{ id:"BPn", html: "<span style='color: #4B0082;'>Bras-Panon</span>", value:"1Eu99fE8gzP8aRvHmC0aoAgGvWLA7sicIJZQzNEHo",  items: [
				 ...
				 { id:"SAd", html: "<span style='color: #006400;'>Saint-André</span>", value:"1nwNhdQtG4G82HAm7m3GnPNLYFYxf7NkLazRvyow9", items: [
				 ...
				 { id:"SB", html: "<span style='color: #008B8B;'>Saint-Benoit</span>", value:"1gdjt3qeIeAvBxMRhmLwlnCgzr7CTt71iJrZ8dCTY", items: [
				 ...
				 { id:"SAn", html: "<span style='color: #800000;'>Sainte-Anne</span>", value:"1s911vZP-Ftzh8TA3JoQSzwuRNbTwkJoZmYna_SFn", items: [
				 ...
				 { id:"SR", html: "<span style='color: #98FB98;'>Sainte-Rose</span>", value:"1gIcPI4SAohpVFM0seVxdlBAw2b2zesvpZH4QJ6DC", items: [
				...
				{ id:"PP", html: "<span style='color: #CD5C5C;'>La Plaine Des Palmistes</span>", value:"1jLXnDeXAjIbdZrgZFiovGef8BTUvyk5PkzoKsfCb", items: [
				 ...
				 { id:"S", html: "<span style='color: #000080;'>Salazie</span>", value:"1zRn7YirASic3zXNjwr0jPpwlUURx5v1w0wK2JGSZ", items: [
					{ id:"S_t", icon:txtInit[7]+"play"+txtInit[8], label: txtInit[0],value:"1UzSHUROSXlwSlMlCe4WQBDyucf1m83YsGbX4FYhP"},
                    { id:"S_s", html: "<span style='color: #FF1493;'>"+txtInit[1]+"</span>",value:"166vivC3Sr59gCaQR98o8-9sXHBfnKiJdX5hH_7tz"},
                    {  id:"S_md", icon:txtInit[7]+"dining"+txtInit[8], label: txtInit[2],value:"1wOqplnMkWf_CHXezRZBC3HvMSf2lcKcnNzgUx8Jp"},
					{ id:"S_v", icon:txtInit[7]+"realestate"+txtInit[8], label: txtInit[3],value:"1oWl8XUdryHiQxlg83t_pu6ERxi4PPOjrvx2Vbuhj"},
					{ id:"S_a", icon:txtInit[7]+"ranger_station"+txtInit[8],label: txtInit[5],value:"1TjFpDyS3jwXAsLdAUL92BdcjM__2SLu71VDkkli_"}						
				 ] }
			]
			},
			{ id:"N",html: "<span style='color: #4169E1;'>NORD</span>", value:"1X7thBX2nmGVIivqpYNzSWN9iC4OCJDvP469Yvr15", items: [
				{ id:"SD", html: "<span style='color: #4B0082;'>Saint-Denis</span>",value:"1B6GQb_eKzR2PmlhSHddq7I8v4KAlYB3HgtLLxWO6", items: [
				 ...
				 { id:"SM", html: "<span style='color: #006400;'>Sainte-Marie</span>",value:"192A1s6RA93KPg1cXOC7QYPI6MyGBb-AZtNpFNnyt", items: [
				 ...
				 { id:"SS", html: "<span style='color: #008B8B;'>Sainte-Suzanne</span>" ,value: "11hA_F8nvGsVVgrtgSs0i4ehviHgHc1kmGDHv1JgS", items: [
				...
				{ id:"Pos",  html: "<span style='color: #800000;'>La Possession</span>",value:"1NjCzAjGKweKavFoZsexcszpxCpx3NEx7pKsNYqED", items: [
				 ...
				 { id:"Por", html: "<span style='color: #98FB98;'>Le Port</span> ",value:"1muRbrt4rHjP_PJWRoIwlywN33ckv-pq3ADitGvI0", items: [
			...
			{ id:"O",html: "<span style='color: #8B0000;'>OUEST</span> ", value:"1t35ApBEMf9xwiZA9EqZd-glj8GexmPuhpSr_ndlh", items: [
				{ id:"Ma", html: "<span style='color: #4B0082;'>Mafate</span>",value:"1GveH25DbaQoreX86sPBmcFei9zfvi8UmD2y2qyqu", items: [
				 ...
				 { id:"SG", html: "<span style='color: #006400;'>Saint-Gilles</span>" ,value:"1sa1fCY5I_xhM7AyYIWyqJedxZzBmGcIfrH1Q8tke", items: [
				 ...
				 { id:"SL",  html: "<span style='color: #008B8B;'>Saint-Leu</span>",value:"1ahKjlUXShjRwyOlo7ZCcZMSvEpJfRG9hY7_Qg6TA",  items: [
				 ...
				 { id:"TB", html: "<span style='color: #800000;'>TroisBassins</span>" ,value:"12g6QNhlYlaTgGoEN_K3Tyl6QV31y6TUPuHXjM-g-", items: [
				 ...
				 { id:"SPA",html: "<span style='color: #98FB98;'>Saint-Paul</span> ",value:"1yPMDk3KG56Dero7Lway4oMIw42daQVKtK0PLjKNZ", items: [
				 ...
				 { id:"ES", html: "<span style='color: #CD5C5C;'>Etang Salé</span>",value:"1XgstlSHKGm72zgrRO6lFUdVSM6867jPyfLT-Mtcj", items: [
				...
				{ id:"ED", html: "<span style='color: #000080;'>Entre-Deux</span>", value:"1uU-__tmwAmqtTXPsi57LhiD969SwF0xWjbnDEw-7", items: [
					{ id:"ED_a", icon:txtInit[7]+"ranger_station"+txtInit[8],label: txtInit[5], value:"1rZG5fmVIUptJwXk5uiJfjVuIn-ooM9WuII0UkEy3"}						
				 ] },
				 { id:"Av", html: "<span style='color: #FFD700;'>Les Avirons</span>", value:"NO", items: [
			...
			{ id:"S",html: "<span style='color: #66CDAA;'>SUD</span>", value:"1XolYmmcAznvjC8X4Gx8vvOWY5a-dJOIyl5ZkWXmM",style:"MediumAquaMarine ", items: [
				{ id:"SPI",  html: "<span style='color: #4B0082;'>Saint-Pierre</span>", value:"1MT3G_b9rZRjqusrdShjZ7kqEHe1JOmq-wp7Wt-JY", items: [
				...
				{ id:"SJ", html: "<span style='color: #006400;'>Saint-Joseph</span>", value:"1EdNBxumLvo_ZKbDvIAmdG4kL4aK8mwn715beAfxU", items: [
				...
				{ id:"PI", html: "<span style='color: #008B8B;'>Petite Ile</span>", value:"1dcDRLQyzoX7G70X4VjHYe5sgNtyiurA4pk5cvwXH", items: [
				 ...
				 { id:"SLO",  html: "<span style='color: #800000;'>Saint-Louis</span> ", value:"1M1iYxQ8PEELVmrQr_3bGh_-7UU09ghn1cvNo8WCV", items: [
				 ...
				 { id:"Ci",html: "<span style='color: #98FB98;'>Cilaos</span> ",value:"1Z0zITHQac_xwSfmHpvliZoioY58jZhUjWs9KX8Ln", items: [
				 ...
				 { id:"T", html: "<span style='color: #CD5C5C;'>Tampon</span>", value:"1fS6sn1x_MDXE8mPT2dJGBE4mLyTseyvgQmt8fS7w", items: [
				 ...
				 { id:"PC", html: "<span style='color: #000080;'>La Plaine Des Cafres</span>", value:"1r3TOcxghV2VoLauNU6PnoY3kzdcSIbtey0pnhWWz", items: [
				  ...
				  { id:"eT",html: "<span style='color: #FFD700;'>enclos du Tremblet</span> ", value:"1b17WXT7XV9FbqVEmjlYXe45ZoIUPCK1sG_sn_WuO", items: [
				  ...
				  ,
				  { id:"SPh",html: "<span style='color: #66CDAA;'>Saint-Phillipe</span> " , value:"1H9qvzwkRMhjjEwgrs_CToYkSPKU9JpKz0NzxRMhY", items: [
