 ...
 *
 */
 $(window).resize(function(){var h=$(window).height();var offsetTop=105;$('#map_canvas').css('height',(h-offsetTop));}).resize();
...
init:function(){var w=$(window).width()/3.5;M.initialize();var exp=true;$(F.I.x).jqxTree({source:F.src,width:w+'px',height:F.H/2}),
